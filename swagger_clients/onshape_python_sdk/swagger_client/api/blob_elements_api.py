...
class BlobElementsApi(object):
    ...
    def create_translation_blob_elements(self, wv_char, did, wv, eid, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_translation_blob_elements(wv_char, did, wv, eid, async=True)
        >>> result = thread.get()
        ...
        :param Body13 body: The JSON request body.
        ...
        if kwargs.get('async'):
            return self.create_translation_blob_elements_with_http_info(wv_char, did, wv, eid, **kwargs)  # noqa: E501
        else:
            (data) = self.create_translation_blob_elements_with_http_info(wv_char, did, wv, eid, **kwargs)  # noqa: E501
            return data

    def create_translation_blob_elements_with_http_info(self, wv_char, did, wv, eid, **kwargs):  # noqa: E501
        """Create Translation  # noqa: E501

        Create an element translation.  The translation may be incomplete at the time that the call        completes.  If the requestState is ACTIVE, the translation can be polled until the state becomes either        DONE or FAILED.  Alternatively, a webhook callback can be registered for notification of translation        completion. (Requires Write scope if storeInDocument is true)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_translation_blob_elements_with_http_info(wv_char, did, wv, eid, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_translation_blob_elements" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('wv_char' not in params or
            ...
            raise ValueError("Missing the required parameter `wv_char` when calling `create_translation_blob_elements`")  # noqa: E501
        # verify the required parameter 'did' is set
        if ('did' not in params or
                params['did'] is None):
            raise ValueError("Missing the required parameter `did` when calling `create_translation_blob_elements`")  # noqa: E501
        # verify the required parameter 'wv' is set
        if ('wv' not in params or
                params['wv'] is None):
            raise ValueError("Missing the required parameter `wv` when calling `create_translation_blob_elements`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in params or
                params['eid'] is None):
            raise ValueError("Missing the required parameter `eid` when calling `create_translation_blob_elements`")  # noqa: E501
    ...
    def download_file_from_element_blob_elements(self, wvm_char, did, wvm, eid, **kwargs):  # noqa: E501
        """Download File From Blob Element  # noqa: E501

        Download a file from a blob element  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.download_file_from_element_blob_elements(wvm_char, did, wvm, eid, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.download_file_from_element_blob_elements_with_http_info(wvm_char, did, wvm, eid, **kwargs)  # noqa: E501
        else:
            (data) = self.download_file_from_element_blob_elements_with_http_info(wvm_char, did, wvm, eid, **kwargs)  # noqa: E501
            return data

    def download_file_from_element_blob_elements_with_http_info(self, wvm_char, did, wvm, eid, **kwargs):  # noqa: E501
        """Download File From Blob Element  # noqa: E501

        Download a file from a blob element  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.download_file_from_element_blob_elements_with_http_info(wvm_char, did, wvm, eid, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_file_from_element_blob_elements" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('wvm_char' not in params or
            ...
            raise ValueError("Missing the required parameter `wvm_char` when calling `download_file_from_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'did' is set
        if ('did' not in params or
                params['did'] is None):
            raise ValueError("Missing the required parameter `did` when calling `download_file_from_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'wvm' is set
        if ('wvm' not in params or
                params['wvm'] is None):
            raise ValueError("Missing the required parameter `wvm` when calling `download_file_from_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in params or
                params['eid'] is None):
            raise ValueError("Missing the required parameter `eid` when calling `download_file_from_element_blob_elements`")  # noqa: E501
    ...
    def get_translation_formats_blob_elements(self, did, wid, eid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_translation_formats_blob_elements(did, wid, eid, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_translation_formats_blob_elements_with_http_info(did, wid, eid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_translation_formats_blob_elements_with_http_info(did, wid, eid, **kwargs)  # noqa: E501
            return data

    def get_translation_formats_blob_elements_with_http_info(self, did, wid, eid, **kwargs):  # noqa: E501
        """Get Translation Formats  # noqa: E501

        Returns a list of the available formats to which this Blob element can be translated. If the                 contained data does not have a recognized input translation format it will not be translatable to                 any other format.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_translation_formats_blob_elements_with_http_info(did, wid, eid, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_translation_formats_blob_elements" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'did' is set
        if ('did' not in params or
                params['did'] is None):
            raise ValueError("Missing the required parameter `did` when calling `get_translation_formats_blob_elements`")  # noqa: E501
        # verify the required parameter 'wid' is set
        if ('wid' not in params or
                params['wid'] is None):
            raise ValueError("Missing the required parameter `wid` when calling `get_translation_formats_blob_elements`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in params or
                params['eid'] is None):
            raise ValueError("Missing the required parameter `eid` when calling `get_translation_formats_blob_elements`")  # noqa: E501
    ...
    def upload_file_create_element_blob_elements(self, file, translate, flatten_assemblies, y_axis_is_up, did, wid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.upload_file_create_element_blob_elements(file, translate, flatten_assemblies, y_axis_is_up, did, wid, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.upload_file_create_element_blob_elements_with_http_info(file, translate, flatten_assemblies, y_axis_is_up, did, wid, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_file_create_element_blob_elements_with_http_info(file, translate, flatten_assemblies, y_axis_is_up, did, wid, **kwargs)  # noqa: E501
            return data

    def upload_file_create_element_blob_elements_with_http_info(self, file, translate, flatten_assemblies, y_axis_is_up, did, wid, **kwargs):  # noqa: E501
        """Upload File to New Blob Element  # noqa: E501

        Create a blob element from an uploaded file. The request body must have a Content-Type of                 multipart/form-data. Request Body parameters are multipart fields.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.upload_file_create_element_blob_elements_with_http_info(file, translate, flatten_assemblies, y_axis_is_up, did, wid, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_file_create_element_blob_elements" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('file' not in params or
                params['file'] is None):
            raise ValueError("Missing the required parameter `file` when calling `upload_file_create_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'translate' is set
        if ('translate' not in params or
                params['translate'] is None):
            raise ValueError("Missing the required parameter `translate` when calling `upload_file_create_element_blob_elements`")  # noqa: E501
        ...
        if ('flatten_assemblies' not in params or
            ...
            raise ValueError("Missing the required parameter `flatten_assemblies` when calling `upload_file_create_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'y_axis_is_up' is set
        if ('y_axis_is_up' not in params or
                params['y_axis_is_up'] is None):
            raise ValueError("Missing the required parameter `y_axis_is_up` when calling `upload_file_create_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'did' is set
        if ('did' not in params or
                params['did'] is None):
            raise ValueError("Missing the required parameter `did` when calling `upload_file_create_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'wid' is set
        if ('wid' not in params or
                params['wid'] is None):
            raise ValueError("Missing the required parameter `wid` when calling `upload_file_create_element_blob_elements`")  # noqa: E501
    ...
    def upload_file_update_element_blob_elements(self, did, wid, eid, file, translate, flatten_assemblies, y_axis_is_up, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.upload_file_update_element_blob_elements(did, wid, eid, file, translate, flatten_assemblies, y_axis_is_up, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.upload_file_update_element_blob_elements_with_http_info(did, wid, eid, file, translate, flatten_assemblies, y_axis_is_up, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_file_update_element_blob_elements_with_http_info(did, wid, eid, file, translate, flatten_assemblies, y_axis_is_up, **kwargs)  # noqa: E501
            return data

    def upload_file_update_element_blob_elements_with_http_info(self, did, wid, eid, file, translate, flatten_assemblies, y_axis_is_up, **kwargs):  # noqa: E501
        """Update Blob Element  # noqa: E501

        Update a blob element by uploading a file. The request body must have a Content-Type of                 multipart/form-data. Request Body parameters are multipart fields.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.upload_file_update_element_blob_elements_with_http_info(did, wid, eid, file, translate, flatten_assemblies, y_axis_is_up, async=True)
        >>> result = thread.get()
        ...
        all_params = ['did', 'wid', 'eid', 'file', 'translate', 'flatten_assemblies', 'y_axis_is_up', 'encoded_filename', 'file_content_length', 'import_in_background', 'allow_faulty_parts']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_file_update_element_blob_elements" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'did' is set
        if ('did' not in params or
                params['did'] is None):
            raise ValueError("Missing the required parameter `did` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'wid' is set
        if ('wid' not in params or
                params['wid'] is None):
            raise ValueError("Missing the required parameter `wid` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'eid' is set
        if ('eid' not in params or
                params['eid'] is None):
            raise ValueError("Missing the required parameter `eid` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'file' is set
        if ('file' not in params or
                params['file'] is None):
            raise ValueError("Missing the required parameter `file` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'translate' is set
        if ('translate' not in params or
                params['translate'] is None):
            raise ValueError("Missing the required parameter `translate` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'flatten_assemblies' is set
        if ('flatten_assemblies' not in params or
                params['flatten_assemblies'] is None):
            raise ValueError("Missing the required parameter `flatten_assemblies` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
        # verify the required parameter 'y_axis_is_up' is set
        if ('y_axis_is_up' not in params or
                params['y_axis_is_up'] is None):
            raise ValueError("Missing the required parameter `y_axis_is_up` when calling `upload_file_update_element_blob_elements`")  # noqa: E501
